...
def is_body_aligned(left_shoulder, left_hip, left_knee, right_shoulder, right_hip, right_knee):
...
class PushupChecker:
    ...
    def update(self, landmarks, mp_pose):
        ...
        if is_body_aligned(left_shoulder, left_hip, left_knee, right_shoulder, right_hip, right_knee):
            ...
            self.feedback = "Body not aligned correctly for pushup."